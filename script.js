...
var swiper = new Swiper(".swiper-container", {
  loop: true,
  autoplay: {
    delay: 3000, // Perpindahan otomatis setiap 3 detik
  },
  pagination: {
  ...
  breakpoints: {
    640: {
      slidesPerView: 1, // 1 slide per layar kecil
      spaceBetween: 10,
    },
    768: {
      slidesPerView: 3, // 2 slide per layar sedang
      spaceBetween: 30,
    },
    1024: {
      slidesPerView: 5, // 3 slide per layar besar
      spaceBetween: 50,
    },
  },
});
